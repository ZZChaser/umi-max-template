import {
  ManageUserControllerCreate,
  ManageUserControllerDetail,
  ManageUserControllerPage,
...
const queryList = async (params: any) => {
  ...
  const res = await ManageUserControllerPage({
    pageNum: current,
    ...rest,
  });
...
const create = async (data: any) => {
  // TODO: 发起请求
  await ManageUserControllerCreate(data);
...
const getRecordDetail = async (id: string) => {
  // TODO: 发起请求
  const { data } = await ManageUserControllerDetail({ id });
  return data;
};
